...
- [samtools](https://www.htslib.org/), junto con `htslib` y `bcftools` [@Danecek2021].
  ...
  Comando: sudo apt install samtools
  
- [freebayes](https://github.com/freebayes/freebayes/releases) [@Garrison2012].
 Comando: git clone  https://github.com/freebayes/freebayes.git
# Objetivos
...
#primero tengo que descargar la función bwa :
...
el número de lecturas duplicadas y la tasa de error de alineamiento.
3. El genoma de referencia incluye dos plásmidos. ¿La cepa secuenciada los tiene?
mediante el comando amtools idxstats DRR025089.bam, se obtiene: 
ENA|CP169752|CP169752.1 9460647 230509  2965
ENA|CP169753|CP169753.1 440193  965     89
ENA|CP169754|CP169754.2 122010  112     3
*       0       0       56574
Por lo que obtenemos tres contigs: uno de 230509 reads, otro de 965 y otro de 112, por lo que se concluye que la cepa tiene el cromosoma principal y uno de los plásmidos pero no el segundo. 
